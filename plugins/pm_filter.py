...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/HeavenForYouAll/8261')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='https://t.me/HeavenForYouAll'),
            InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/HeavenRequest')
        ], [
            InlineKeyboardButton('ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('ᴀʙᴏᴜᴛ', callback_data='about')
        ], [
            InlineKeyboardButton('ᴄʟᴏsᴇ ᴍᴇɴᴜ', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('ғɪʟᴛᴇʀs', callback_data='filter_menu'),
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text='𝖢𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 𝖨 𝖧𝖺𝗏𝖾 2 𝖥𝗂𝗅𝗍𝖾𝗋 𝖮𝗉𝗍𝗂𝗈𝗇𝗌 𝖠𝗏𝖺𝗂𝗅𝖻𝗅𝖾',
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        buttons = [[
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='filter_menu'),
